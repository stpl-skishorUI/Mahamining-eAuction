<%@ Page Title="Participate" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="eAuctionParticipate.aspx.cs" Inherits="Mahamining_e_Auction.eAuctionParticipate" %>
                    ...
                    <table class="mb-0 table table-hover event_table">
                        ...
                        <tbody id="" class="align-middle ">
                            <tr class="">
                                ...
                                <td>
                                    <span>10/10/2020</span><br>
                                    <span>10:45:09</span><br>
                                </td>
                                <td>
                                    <span>22/10/2020</span><br>
                                    <span>09:15:00</span>
                                </td>
                                <td class="">
                                    <div class="d-flex align-items-center">
                                        Upload Documents <i class="fa fa-angle-double-right text-primary "></i>
                                    </div>
                                </td>
                            </tr>
                            <tr>
