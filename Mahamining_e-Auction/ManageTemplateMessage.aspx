<%@ Page Title="Manage Template Message" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageTemplateMessage.aspx.cs" Inherits="Mahamining_e_Auction.ManageTemplateMessage" %>
    ...
    <div class="paymentCards">
        <div class="card border-0 shadow-none">
            <div class="card-header bg-transparent border-bottom-0">
                <div class="row">
                    <div class="col">
                        <h6 class="text-theme mb-0 fw-bold">Manage Messages</h6>
                    </div>
                    <div class="col-auto">
                            ...
                            <table class="table table-bordered rounded event_table et_2 mb-0">
                                ...
                                <tbody class="padY10">
                                    <tr>
                                        ...
                                        <td>Demoauction</td>
                                        <td>Welcome To The Online Auction For Sale Of Scrap Material Offered By M/S</td>
